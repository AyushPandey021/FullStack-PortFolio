    ...
    <main className="min-h-screen bg-[var(--bg-primary)] text-[var(--text-primary)]">
      ...
      <section className="relative px-5 pt-24 pb-16">
        ...
        <div className="relative mx-auto max-w-[1200px] text-center">
          ...
          >
            Ayush combines product taste with full-stack execution: crisp
            interfaces, reliable APIs, database design, AI integrations, and
            deployment workflows that hold up after launch.
          </motion.p>
        </div>
      </section>
          ...
          >
            <div>
              ...
              <p className="text-gray-300 leading-relaxed mb-6">
                ...
                also maintainable and scalable. Every line of code should have a
                purpose, every component should be reusable, and every
                interaction should feel intuitive.
              </p>
              <p className="text-gray-300 leading-relaxed">
                With years of experience across the full stack, I understand how
                all the pieces fit together - from the database layer to the
                user interface. This holistic perspective allows me to make
